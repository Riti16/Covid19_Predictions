...
app.layout = html.Div([
    ...
    html.Ol([
        ...
        html.Li(["Also, at some point, healed people will not spread the virus anymore and when (almost) everyone is or has been infected, the growth will stop.", style={'fontSize': 10}], style={'fontSize': 10})
    ]),
